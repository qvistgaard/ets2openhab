...
public class RoomTemperatureRollover extends SupportedLinePattern {

	public RoomTemperatureRollover(CSVRecord record) throws Exception {
		super(record);
	}

	@Override
	protected Pattern getPattern() {
		return Pattern.compile("(.*?)-RTR$");
	}
