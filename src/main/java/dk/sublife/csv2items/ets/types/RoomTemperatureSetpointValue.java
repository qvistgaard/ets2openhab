...
public class RoomTemperatureSetpointValue extends SupportedLinePattern {

	public RoomTemperatureSetpointValue(CSVRecord record) throws Exception {
		super(record);
	}

	@Override
	protected Pattern getPattern() {
		return Pattern.compile("(.*?)-RT-SP-VAL$");
	}
