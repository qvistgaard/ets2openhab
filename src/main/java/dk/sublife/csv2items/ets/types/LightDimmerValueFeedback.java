...
public class LightDimmerValueFeedback extends SupportedLinePattern {

	public LightDimmerValueFeedback(CSVRecord record) throws Exception {
		super(record);
	}

	@Override
	protected Pattern getPattern() {
		return Pattern.compile("(.*?)-DIM-VAL-FB$");
	}
